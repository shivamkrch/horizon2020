...
<head>
    ...
    <title>Horizon 2k20 | The annual Techfest of BCREC</title>
</head>
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 mx-auto col-lg-10">
                    ...
                    <div class="entry-header">
                        <h3><span class="text-warning mr-3">Cultural Fest: </span>13 February, 2020</h3>
                        <h3><span class="text-info mr-3">Techfest: </span>14-15 February, 2020</h3>
                    </div><!-- .entry-header -->
